...
public  class HewanAdapter extends RecyclerView.Adapter<HewanAdapter.HewanViewHolder>{
    ...
    public HewanAdapter(Context context, List<Upload> uploads) {
        mContext = context;
        mUploads = uploads;
    }

    @Override
    public HewanViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.view_hewan, parent, false);
        return new HewanViewHolder(v);
    }
